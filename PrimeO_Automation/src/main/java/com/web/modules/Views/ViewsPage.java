...
private void selectTableColumnsVar21(String ViewColumnsList) throws Exception {
	   ...
	   for( i=1;i<=count;i++){
	    System.out.println("Count is "+count+" and Value of i "+i+" is --"+ driver.findElement(By.xpath("html/body/div[2]/div[3]/div/div/div/div/div/div[3]/div[2]/div/div[1]/table["+i+"]/tbody/tr/td[2]/div")).getText().trim());
	         for( j=0;j<strList.length;j++){
	          //System.out.println("Value of j is "+strList[j]);
	           if(driver.findElement(By.xpath("html/body/div[2]/div[3]/div/div/div/div/div/div[3]/div[2]/div/div[1]/table["+i+"]/tbody/tr/td[2]/div")).getText().trim().equalsIgnoreCase(strList[j]))
	           {
	            WebElement source=driver.findElement(By.xpath("html/body/div[2]/div[3]/div/div/div/div/div/div[3]/div[2]/div/div[1]/table["+i+"]/tbody/tr/td[2]/div"));
	    System.out.println(source.getText());
	    ...
	    action.dragAndDrop(source, dest).build().perform();
		   ...
		   int size=TotlaColumns-1;
	    System.out.println("Scrolling down .............");
 WebElement ele1=driver.findElement(By.xpath("html/body/div[2]/div[3]/div/div/div/div/div/div[3]/div[2]/div/div[1]/table["+size+"]/tbody/tr/td[2]/div"));
		...
		executor.executeScript("arguments[0].click();", ele1);
	     ...
	     for( i=1;i<=count1;i++){
	      System.out.println("Count is "+count1+" and Value of i "+i+" is --"+ driver.findElement(By.xpath("html/body/div[2]/div[3]/div/div/div/div/div/div[3]/div[2]/div/div[1]/table["+i+"]/tbody/tr/td[2]/div")).getText().trim());
	           for( j=0;j<strList.length;j++){
	            //System.out.println("Value of j is "+strList[j]);
	            WebElement webele=driver.findElement(By.xpath("html/body/div[2]/div[3]/div/div/div/div/div/div[3]/div[2]/div/div[1]/table["+i+"]/tbody/tr/td[2]/div"));
	            if(webele.isDisplayed()){
	            	JavascriptExecutor executor1 = (JavascriptExecutor)driver;
	        		executor1.executeScript("arguments[0].click();", webele);
	             if(driver.findElement(By.xpath("html/body/div[2]/div[3]/div/div/div/div/div/div[3]/div[2]/div/div[1]/table["+i+"]/tbody/tr/td[2]/div")).getText().trim().equalsIgnoreCase(strList[j]))
	             {
	              WebElement source=driver.findElement(By.xpath("html/body/div[2]/div[3]/div/div/div/div/div/div[3]/div[2]/div/div[1]/table["+i+"]/tbody/tr/td[2]/div"));
	      System.out.println(source.getText());
